...
// import "../components/styles/css/footer.css";
// import logo from "../assets/img/logo_investmango.png";
// import { getAllGenericKeywords, getGenericKeywordByPath, getAllCities } from "../apis/api";
...
//         const regex = /\/search\/([^?]+)(?:\?city=([^&]+))?(?:&category=([^&]+))?/; // Define the regex pattern
...
//             const [, term, city, propertyCategory] = genericTermData.url.match(regex);
//             if (city) {
...
//         <div className="callnow">
//           <a href="tel:+918368547490">
//             <i style={{ transform: "rotate(95deg)" }} className="fas fa-phone"></i> 8368547490
//           </a>
//         </div>
//       </div>
//       <button
...
//                   <ul className="footer-links">
//                     <li>
//                       <Link to={`/search/${item.path}`} className="text-reset text-start">
//                         {item.keywords}
//                       </Link>
//                     </li>
//                   </ul>
...
//                 </ul>
//                 <div className="social-links">
//                   <a href="https://twitter.com/investmango" target="_blank" rel="noopener noreferrer">
//                     <img
//                       src="https://imagedelivery.net/MbjggtGD4dFDFpyznW77nA/e6391943-c9b2-40a0-0eb9-1e14df3c8800/public"
//                       alt="Facebook"
//                       className="social-icon"
...
//                     />
//                   </a>
//                   <a href="https://instagram.com/investmango" target="_blank" rel="noopener noreferrer">
//                     <img
//                       src="https://imagedelivery.net/MbjggtGD4dFDFpyznW77nA/00c6899a-05e6-488c-2ff6-1c5fd2d8bc00/public"
//                       alt="Instagram"
//                       className="social-icon"
//                     />
//                   </a>
//                   <a href="https://www.linkedin.com/company/investmango/" target="_blank" rel="noopener noreferrer">
//                     <img
//                       src="https://imagedelivery.net/MbjggtGD4dFDFpyznW77nA/6e591ec2-b5f2-4a01-6a43-4287e23c2300/public"
//                       alt="LinkedIn"
//                       className="social-icon"
//                     />
//                   </a>
//                   <a href="https://www.youtube.com/channel/UCkQZ1pJJTnEZG5XOyJsthhA" target="_blank" rel="noopener noreferrer">
//                     <img
//                       src="https://imagedelivery.net/MbjggtGD4dFDFpyznW77nA/a3003793-d9c2-4393-222e-b1dd3deb6e00/public"
//                       alt="YouTube"
//                       className="social-icon"
...
//                   <li className="add">
//                     <a href="https://goo.gl/maps/ULh6up2ZDQb78Rsm7">
//                       11th Floor, Plot no 6, Magnus Tower, Sector 73, Noida, Uttar Pradesh 201307
//                     </a>
//                   </li>
//                   <li>
//                     <a href="tel:+91-8595-189-189">
