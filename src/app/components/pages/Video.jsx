      ...
      const sortedProjects = data
        ? data
            ...
            .map((project) => {
              ...
              return {
                ...project,
                processedConfig: combinedOutput || "Property Type",
              };
            })
                  ...
                  projects.map((project) => (
                    <div className="col-md-4" key={project.project_id}>
                      ...
                      >
                        ...
                        <p className="list_headline_two" style={{ fontSize: "20px" }}>
                          {project.project_name}
                        </p>
                        <p className="location_im">
                          <i className="fas fa-map-marker-alt"></i> {project.short_address}
                        </p>
