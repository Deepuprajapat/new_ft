      ...
      <div className="px-3">
        <div
          ...
          style={{
            ...
            outline: isVideoEditing ? "1px solid #2067d1" : "none",
            background: isVideoEditing ? "#f8faff" : "transparent",
            borderRadius: "4px",
            padding: isVideoEditing ? "8px" : "0",
            cursor: isVideoEditing ? "text" : "default",
            minHeight: "40px",
          }}
          contentEditable={isVideoEditing}
          suppressContentEditableWarning={true}
          onInput={(e) => setVideoPara(e.currentTarget.innerHTML)}
          dangerouslySetInnerHTML={{
            __html: DOMPurify.sanitize(
              isVideoEditing ? videoPara : projectData?.videoPara
            ),
          }}
        />
